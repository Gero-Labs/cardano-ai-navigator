  ...
  return (
    <div className="space-y-6 relative">
      <div className="absolute inset-0 -z-10 overflow-hidden rounded-lg">
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200%] h-[200%] bg-gradient-to-br from-transparent via-accent/30 to-transparent animate-spin-slow opacity-30"
      ...
      {(orderStage === "negotiating" ||
        orderStage === "executing" ||
        orderStage === "creating") && (
